        ...
        <div className="flex gap-6">
          ...
          <div className="flex gap-1 items-center">
            <Button
              ...
              variant="ghost"
              className={cn(
                "text-foreground/75 rounded-full",
                isActive("/hero-section") && "text-foreground"
              )}
            >
            ...
            <div className="relative flex items-center">
              <Button
                ...
                className={cn(
                  "text-foreground/75 rounded-full",
                  isActive("/snippets/button") && "text-foreground"
                )}
              >
              ...
              <span className="rounded-full border border-green-300 bg-green-200 px-1.5 py-px text-xs text-green-900 dark:border-green-700 dark:bg-green-500/20 dark:text-green-50">
                New
              </span>
            </div>
          </div>
